...
import DiscoveryService from __main + "services/DiscoveryService";
import LEDStrip from __main + "models/LEDStrip";
import FlickerstripDispatcher from __main + "dispatcher/FlickerstripDispatcher";
